...
The app currently uses a single default shadcn Neutral light theme. Shared tokens
...
The current build is intentionally frontend-only. State is stored in the browser
and can be exported as JSON from Settings → Data. A backend can be introduced
