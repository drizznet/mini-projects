 ...
 *
 * A reducer holds the graph and a `FocusRepository` persists it. The default is
 * the localStorage repository, so the MVP is fully offline; pass a Supabase
 * repository to `FocusStoreProvider` to go remote without touching the reducer
 * or any component.
 *
...
export function FocusStoreProvider({
  ...
  children: ReactNode;
  /** Defaults to localStorage; pass a Supabase repository to go remote. */
