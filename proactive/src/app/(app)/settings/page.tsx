...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <PageHeader
        title="Settings"
        description="Targets, rituals and the vocabulary the analytics use. Changes apply immediately."
      />
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                actions.updateSettings({ theme: checked ? "dark" : "light" })
              }
      ...
      <Card>
        <CardHeader>
          <div>
            ...
            <CardDescription>
              Everything lives in this browser until Supabase is wired up
            </CardDescription>
          </div>
        </CardHeader>
